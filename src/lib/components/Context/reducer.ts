...
export type Action =
  ...
  | { type: 'TOGGLE_BOLD' }
  | { type: 'TOGGLE_ITALIC' }
  | { type: 'SET_TEXT_CASE'; data: 'initial' | 'uppercase' | 'lowercase' | 'capitalize' }
  | { type: 'SET_TEXT_ALIGNMENT'; data: 'initial' | 'left' | 'right' | 'center' | 'justify' }
